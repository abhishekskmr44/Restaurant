        ...
        <div style={{ border: "1px solid rgb(243,243,243)", background: "rgb(243,243,243)", marginBottom: 10, flex: 1, padding: 10, width: "600px" }}>
            ...
            >
                ...
                <div style={{ textAlign: "left", paddingLeft: 10, flex: 2, lineHeight: "12px" }}>
                    ...
                    {cash && card ? (
                        <p style={{fontSize: "15px", fontWeight: "500"}}> Accepts Cash and Card both</p>
                    ) : card ? (
                        <p style={{fontSize: "18px", fontWeight: "500"}}> Accepts Card only</p>
                    ) : (
                        <p style={{fontSize: "18px", fontWeight: "500"}}> Accepts Cash only</p>
                    )}
                </div>
